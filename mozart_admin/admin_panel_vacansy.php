...
<body>
    ...
    <h1>Редактор вакансий</h1>
    <p>Вы можете добавить новые вакансии, изменить старые или удалить их. 
    ...
    <form method="post" action="php_admin/save_vacansy.php">
        <textarea name="editor1" id="editor1" rows="10" cols="80">
            <?
                $get_vacancy = "SELECT text_change
                FROM m_admin_change_html WHERE id_page=1";
